...
const rankingList = params => {
  return http.get(`/api/home/ranking/rankingList`, params).then(res => res.data);
};
...
const getUnBeginMatch = params => {
  return http.post(`/api/home/now_match/getUnBeginMatch`, params).then(res => res.data);
};
const getOneMatchBaiJia = params => {
  return http.post(`/api/home/now_match/getOneMatchBaiJia`, params).then(res => res.data);
};
const getOneMatchDetail = params => {
  return http.post(`/api/home/now_match/getOneMatchDetail`, params).then(res => res.data);
};
const getOneMatchInformation = params => {
  return http.post(`/api/home/now_match/getOneMatchInformation`, params).then(res => res.data);
};
const getEndMatchByTeamId = params => {
  return http.post(`/api/home/now_match/getEndMatchByTeamId`, params).then(res => res.data);
};
const getUnBeginMatchByTeamId = params => {
  return http.post(`/api/home/now_match/getUnBeginMatchByTeamId`, params).then(res => res.data);
};
const getTwoTeamMatchEd = params => {
  return http.post(`/api/home/now_match/getTwoTeamMatchEd`, params).then(res => res.data);
};
...
const getArticleDetail = params => {
  return http.post(`/api/home/article/getArticleDetail`, params).then(res => res.data);
};
